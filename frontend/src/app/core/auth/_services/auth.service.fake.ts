...
import {UsersTable} from "../_server/users.table";
...
export class AuthService {
    private baseUrl = 'http://hub.test/api';
    private user: any;
    private list: any;
    private usermodel: any;
    private iss = {
        login: 'http://hub.test/api/auth/login',
        signup: 'http://hub.test/api/auth/register'
    };
    constructor(private http: HttpClient,
                private httpUtils: HttpUtilsService, private service: TycketService) { }
    ...
    register(user: User): Observable<any> {
        ...
        this.service.register(_user).subscribe(result => {
            this.usermodel = {
                id: result['user']['id'],
                username: result['user']['username'],
                password: this.user['password'],
